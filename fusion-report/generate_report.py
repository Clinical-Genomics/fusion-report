...
def generate_index(params, parser, known_fusions, unknown_fusions):
    ...
    fusion_list_section.data = create_fusions_table(parser.get_fusions(), parser.get_tools(), known_fusions, params.tool_num)
...
def generate_report(params):
    ...
    for fusion in fusions:
        ...
        # Possible parallel job?
        # With some nice progress bar
